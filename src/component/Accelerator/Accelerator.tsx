      ...
      <div className={styles.serviceContent}>
        <div className={styles.rectangleParent1}>
          ...
          <div className={styles.description}>
            Standardized token management workflow in the Bitcoin Layer 2 space
            by offering features such as liquidity locks, staking, token
            creation, team token locks, and token vesting, while also providing
            user management and a marketplace for vested tokens.
          </div>
        </div>
